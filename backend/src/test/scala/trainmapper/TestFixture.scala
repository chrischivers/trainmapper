...
//import trainmapper.networkrail.{MovementMessageReceiver, TrainActivationMessage}
...
//                            movementMessageHandler: MovementMessageReceiver,
...
//        movementMessageHandler <- IO(MovementMessageReceiver(activationCache, scheduleTable)(clock))
//      } yield {
